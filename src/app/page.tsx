...
import ScrollAnimation from "@/components/ScrollAnimation"; // Import animation component
import {
  IoMailOutline,
  IoArrowForward,
  IoCheckmarkCircle,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {features.map((feature, index) => (
                <ScrollAnimation key={index} direction="up" delay={index * 0.1} className="h-full">
                  <div
                    className="group bg-card-dark border border-white/10 p-6 rounded-2xl hover:border-primary/50 transition-all hover:-translate-y-1 h-full"
                  >
